...
ggplot() + geom_line(small, mapping = aes(x = Time_avg, y = Concentration_avg, color = "small")) + 
  ...
  geom_errorbar(small, mapping = aes(x = Time_avg, y = Concentration_avg, ymin = Concentration_avg - se_small, ymax = Concentration_avg + se_small, color = "small"), width = .7) + 
  geom_errorbar(large, mapping = aes(x = Time_avg, y = Concentration_avg, ymin = Concentration_avg - se_large, ymax = Concentration_avg + se_large, color = "large"), width = .7) + 
